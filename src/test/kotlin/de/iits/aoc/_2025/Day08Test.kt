...
internal class Day08Test {
    ...
    @Test
    fun testExample() {
        val result = sut.calculate(getInputForDay(day, example = true, 2025), 10)
    ...
    @Test
    fun testInput() {
        val result = sut.calculate(getInputForDay(day, false, 2025), 1000)
        println(result) //163548
    }

    @Test
    fun testInput2() {
        val result = sut.calculate2(getInputForDay(day, false, 2025))
        println(result) //772452514
    }
}